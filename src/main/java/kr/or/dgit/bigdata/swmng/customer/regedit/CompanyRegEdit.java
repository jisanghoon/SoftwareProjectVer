...
public class CompanyRegEdit extends JPanel implements ActionListener, RegEditInterface {
	...
	public CompanyRegEdit(String e, int flag) {
		...
		gbl_AddPanel.columnWidths = new int[] { 0, 41, 0 };
		gbl_AddPanel.rowHeights = new int[] { 38, 0, 0, 0, 0, 0, 0 };
		gbl_AddPanel.columnWeights = new double[] { 0.0, 0.0, 0.0 };
		...
		gbc_tfCoName.anchor = GridBagConstraints.WEST;
		gbc_tfCoName.insets = new Insets(0, 0, 5, 0);
		gbc_tfCoName.gridx = 1;
		...
		gbc_tfTel.anchor = GridBagConstraints.WEST;
